...
export const STATION_ENTRIES = Object.entries(TRAIN_STATIONS)
export const STATION_VALUES = Object.keys(TRAIN_STATIONS)
export const STATION_KEYS = Object.values(TRAIN_STATIONS)

export const REQUEST_STATIONS = [
	[
		'Abererch',
		'Achanalt',
		'Achnashellach',
...
const CATEGORY_A_TO_D_STATIONS = [
...
export const GWR_WEST_STATIONS = [
	'Newton Abbot',
	'Totnes',
	'Ivybridge',
	'Plymouth',
...
export const PRIMARY_VIA_STATIONS = [
...
export const SECONDARY_VIA_STATIONS = [
	'Altrincham',
	'Barnsley',
	'Barrow on Furness',
	'Blackburn',
...
export const ABBREVIATIONS = [
	...
	{
		original: 'for Tewkesbury',
		new: '',
	},
	{ original: '& Burnham', new: '' },
	{ original: 'Cranswick', new: "C'wick" },
	{ original: 'Low Level', new: 'LL' },
	{ original: 'High Level', new: 'HL' },
	{ original: 'Thorns', new: 'T' },
	{ original: 'Kirkoswald', new: "K'wald" },
	{ original: 'Outward Bound', new: '' },
	{ original: 'Waterloo East', new: "W'loo East" },
	{ original: 'Upper', new: 'U' },
	{ original: 'Football Ground', new: 'FC' },
	{ original: '& Thame Parkway', new: '' },
	{ original: 'for Eskdale', new: '' },
	{ original: 'Cardiff International Airport', new: "Cardiff Int'l" },
	{ original: 'Hill Marple', new: 'Hill' },
	{ original: 'Harbour', new: 'Hbr' },
	{ original: 'Southsea', new: "S'sea" },
	{ original: '& Parkhouse', new: '' },
	{ original: 'Broadway', new: "B'way" },
	{ original: 'Newtown', new: "N'town" },
	{ original: '& Goodwick', new: "& G'wick" },
	{ original: '& Burry Port', new: '& B Port' },
	{ original: 'Risborough', new: "R'boro" },
	{ original: 'Stainforth', new: 'S' },
	{ original: 'Terminals 1, 2 and 3', new: 'T1-3' },
	{ original: 'Terminal 4', new: 'T4' },
	{ original: 'Terminal 5', new: 'T5' },
	{ original: 'Thorton', new: "T'ton" },
	{ original: 'Abbey Wood', new: 'Abbey W' },
	{ original: 'Beach', new: 'B' },
	{ original: 'New Forest', new: '' },
	{ original: 'Park', new: 'Pk' },
	{ original: 'Paddington', new: 'Pad' },
	{ original: 'Lochalsh', new: "L'halsh" },
	{ original: 'Street', new: 'St' },
	{ original: 'Hill', new: 'Hl' },
	{ original: 'Forster', new: 'F' },
	{ original: 'Central', new: 'Ctrl' },
	{ original: 'Golf Club', new: 'G C' },
	{ original: 'Piccadilly', new: 'Pic' },
	{ original: 'Queen Margaret', new: 'Queen M' },
	{ original: 'Borehamwood', new: "B'hamwood" },
	{ original: 'Foregate', new: "F'gate" },
	{ original: 'Grahamston', new: "G'hamston" },
	{ original: 'Parkway', new: 'Pkway' },
	{ original: 'Valley', new: 'V' },
	{ original: 'Meads', new: 'M' },
	{ original: 'Junction', new: 'Jn' },
	{ original: 'Interchange', new: 'Int' },
	{ original: 'International', new: "Int'l" },
	{ original: 'Swalecliffe', new: "S'cliffe" },
	{ original: 'Oswaldtwistle', new: 'O' },
	{ original: 'Thameslink', new: "T'link" },
	{ original: 'Cross', new: 'X' },
	{ original: 'Road', new: 'Rd' },
	{ original: 'Heath', new: 'H' },
	{ original: '& New Inn', new: '' },
	{ original: 'Shrub', new: 'Shb' },
	{ original: 'North', new: 'Nth' },
	{ original: 'North Western', new: 'N W' },
	{ original: '& Jordans', new: '' },
	{ original: 'Ferrers', new: 'F' },
	{ original: 'Kirkgate', new: "K'gate" },
	{ original: 'Westgate', new: "W'gate" },
	{ original: 'Wishing Well Halt', new: '' },
	{ original: 'Bank Quay', new: 'B Q' },
	{ original: 'Riverside', new: "R'side" },
	{ original: 'Warrior Square', new: '' },
	{ original: 'for Penketh', new: '' },
	{ original: 'Square', new: 'Sq' },
	{ original: 'South', new: 'Sth' },
	{ original: 'Victoria', new: 'Vic' },
	{ original: 'West', new: 'W' },
]

const LONDON_STATIONS = STATION_VALUES.filter(
	stations =>
		stations.startsWith('London') &&
		!stations.endsWith('Fields') &&
		!stations.includes('Road')
)

export const MAJOR_STATIONS = [...CATEGORY_A_TO_D_STATIONS, ...LONDON_STATIONS]

export const STOPS_CONTAINS_REQUEST =
	'(x) denotes request stop, if you intend to alight at one of the stations, please ask the conductor to arrange for the train to stop, to allow you to alight'
export const STOP_IS_REQUEST =
	'This train stops on request, if you intend to board this train, please signal your intent to board, for the train to stop'
